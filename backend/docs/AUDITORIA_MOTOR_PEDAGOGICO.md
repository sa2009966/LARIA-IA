...
> | W2 | Dedup con techo de 256 `applied_event_ids` | **Sin efecto** — la reclamación del outbox eliminó el escenario de re-entrega masiva ([ADR-010](adr/ADR-010-entrega-del-outbox-con-lease.md)) |
...
> | W7 | Señales por regex frágil | **Parcial** — normalización, cobertura ampliada y patrones acotados por materia ([ADR-011](adr/ADR-011-calidad-de-la-evidencia.md)); sigue siendo regex, no semántica |
...
> | W12 | Concurrencia optimista sin backoff | **Resuelto** — backoff exponencial con jitter, acotado (ADR-010) |
