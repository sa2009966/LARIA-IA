...
# Conceptos frecuentes en preguntas (heurística ligera)
_CONCEPT_PATTERNS: list[tuple[re.Pattern[str], str]] = [
    ...
    (re.compile(r"\bpobreza\b", re.I), "pobreza"),
    (re.compile(r"\bgini\b", re.I), "indice de gini"),
    (re.compile(r"\bmovilidad\s+social\b", re.I), "movilidad social"),
    (re.compile(r"\binformalidad\b", re.I), "informalidad laboral"),
]
